...
struct MappingData
{
  ...
  // odom_depth_timeout_
  rclcpp::Time last_occ_update_time_{0L, RCL_SYSTEM_TIME};
...
private:
  ...
  void odomCallback(const nav_msgs::msg::Odometry::ConstPtr &odom);
  ...
  rclcpp::Node::SharedPtr node_ = rclcpp::Node::make_shared("a_star");
  ...
  rclcpp::Subscription<nav_msgs::msg::Odometry>::SharedPtr indep_odom_sub_, extrinsic_sub_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr map_pub_, map_inf_pub_, esdf_pub_;
